...
urlpatterns = [
	...
	path('disciplinas_rc_1s', disciplinas_rc_1s),
	path('disciplinas_rc_2s', disciplinas_rc_2s),
	path('disciplinas_rc_3s', disciplinas_rc_3s),
	path('disciplinas_rc_4s', disciplinas_rc_4s),
